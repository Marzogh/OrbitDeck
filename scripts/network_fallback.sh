...
KNOWN_PROFILES=$(nmcli -t -f NAME connection show | grep -v "^ISS-Tracker-AP$" || true)
...
echo "No known SSIDs available. Starting AP fallback profile ISS-Tracker-AP"
nmcli connection up "ISS-Tracker-AP"
